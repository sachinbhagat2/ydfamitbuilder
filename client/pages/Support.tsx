              ...
              <div className="bg-white border border-ydf-light-gray rounded-lg overflow-hidden">
                <div className="p-4 h-96 overflow-y-auto space-y-3">
                  {chatMessages.map((m, i) => (
                    ...
                    >
                      <div
                        className={`${m.role === "user" ? "bg-ydf-deep-blue text-white" : "bg-gray-100 text-gray-800"} px-3 py-2 rounded-lg max-w-[80%]`}
                      >
                        <div className="text-sm">{m.text}</div>
                        <div
                          className={`text-[10px] mt-1 ${m.role === "user" ? "text-blue-100" : "text-gray-500"}`}
                        >
                          {m.time}
                        </div>
                      </div>
                ...
                <form
                  onSubmit={(e) => {
                    ...
                    setTimeout(() => {
                      ...
                      let reply = "Thanks! Our team will get back shortly.";
                      if (txt.includes("status") || txt.includes("track"))
                        reply =
                          "You can track your application in the Progress page.";
                      if (txt.includes("apply"))
                        reply =
                          "Browse Scholarships and click Apply. I can guide you.";
                      if (txt.includes("profile"))
                        reply =
                          "Open Profile to update your details. Changes require Save.";
                ...
                >
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-ydf-light-gray rounded-lg focus:ring-2 focus:ring-ydf-deep-blue focus:border-transparent"
                  />
                  <button
                    type="submit"
